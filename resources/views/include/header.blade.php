...
<html>
    <head>
        ...
        <title>{{ config('constant.app_name') }} - Admin Panel</title>
                ...
                <div class="sidebar-inner slimscroll">
                    <div id="sidebar-menu" class="sidebar-menu">
                        <ul>
                            ...
                            <li class="submenu-open">
                                <h6 class="submenu-hdr">FAQ</h6>
                                <ul id="main_menu_list">
                                    <li class="permission" data-module="faq" data-title="FAQ">
                                        <a href="{{ url('admin/faqs') }}"><i data-feather="box"></i><span>FAQ List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu-open">
                                ...
                                <ul id="main_menu_list">
                                    <li class="permission" data-module="blog" data-title="Blog">
                                        <a href="{{ url('admin/blogs') }}"><i data-feather="box"></i><span>Blog List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu-open">
                                <h6 class="submenu-hdr">Service</h6>
                                <ul id="main_menu_list">
                                    <li class="permission" data-module="service" data-title="Service">
                                        <a href="{{ url('admin/services') }}"><i data-feather="box"></i><span>Service List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu-open">
                            ...
                            <li class="submenu-open">
                                <h6 class="submenu-hdr">Review</h6>
                                <ul id="main_menu_list">
                                    <li class="permission" data-module="review" data-title="Review">
                                        <a href="{{ url('admin/reviews') }}"><i data-feather="box"></i><span>Review List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu-open">
                                <h6 class="submenu-hdr">Inquiry</h6>
                                <ul id="main_menu_list">
                                    <li class="permission" data-module="inquiry" data-title="Inquiry">
                                        <a href="{{ url('admin/inquiries') }}"><i data-feather="box"></i><span>Inquiry List</span></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="submenu-open">
                            ...
                            <li class="submenu-open">
                                ...
                                <ul id="main_menu_list">
                                    ...
                                    <li class="permission" data-module="useful_link" data-title="Link">
                                        <a href="{{ url('admin/tools') }}"><i data-feather="box"></i><span>Useful Link List</span></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
