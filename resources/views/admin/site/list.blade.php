	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="page-wrapper-new p-0">
				<div class="content">
					<form action="{{ route('admin.upload.site') }}" method="POST" enctype="multipart/form-data">
						@csrf
